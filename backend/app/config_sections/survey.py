...
TOO_FAST_ATTENTION_BASE_SECONDS = float_env("TOO_FAST_ATTENTION_BASE_SECONDS", 10.0, min_value=0.0)
TOO_FAST_SURVEY_BASE_SECONDS = float_env("TOO_FAST_SURVEY_BASE_SECONDS", 14.0, min_value=0.0)
TOO_FAST_ATTENTION_MAX_THRESHOLD_SECONDS = float_env("TOO_FAST_ATTENTION_MAX_THRESHOLD_SECONDS", 90.0, min_value=1.0)
TOO_FAST_SURVEY_MAX_THRESHOLD_SECONDS = float_env("TOO_FAST_SURVEY_MAX_THRESHOLD_SECONDS", 100.0, min_value=1.0)
