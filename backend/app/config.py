...
CACHE_REDIS_URL = _str_env("CACHE_REDIS_URL", "", allow_blank=True)
CACHE_REDIS_PREFIX = _str_env("CACHE_REDIS_PREFIX", "cognit", allow_blank=False)
PAYMENT_STATUS_CACHE_TTL_SECONDS_ACTIVE = _float_env("PAYMENT_STATUS_CACHE_TTL_SECONDS_ACTIVE", 1.0, min_value=0.1, max_value=60.0)
PAYMENT_STATUS_CACHE_TTL_SECONDS_TERMINAL = _float_env("PAYMENT_STATUS_CACHE_TTL_SECONDS_TERMINAL", 15.0, min_value=1.0, max_value=3600.0)
PARTICIPANT_OPTIONS_CACHE_TTL_SECONDS = _float_env("PARTICIPANT_OPTIONS_CACHE_TTL_SECONDS", 300.0, min_value=1.0, max_value=3600.0)
