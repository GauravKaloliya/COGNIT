...
REGEX_PAID_TO_COGNIT = re.compile(r"paid\s+to\s+cognit", re.IGNORECASE)
REGEX_PAID_TO_GAURAV = re.compile(r"\bpaid\s+to\s+gaurav\b", re.IGNORECASE)
REGEX_PAID_GAURAV = re.compile(r"\bpaid\s+gaurav\b", re.IGNORECASE)
REGEX_PAID = re.compile(r"\bpaid\b", re.IGNORECASE)
REGEX_GAURAV = re.compile(r"\bgaurav\b", re.IGNORECASE)
