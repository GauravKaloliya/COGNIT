...
def submit():
    ...
    result = db.execute(text("SELECT consent_given FROM participants WHERE id = :participant_fk"),
                       {"participant_fk": participant_fk})
...
def _get_api_documentation():
    return {
        ...
        "endpoints": {
            ...
            "confirm_payment": {"path": "/payment/confirm", "method": "POST", "auth_required": False},
