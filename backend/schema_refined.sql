...
-- Refined final-state schema: legacy compatibility ALTER blocks and
-- migration-only DO $$ sections have been removed for readability.
--
-- Best companion file:
--   backend/DL_MODEL_DATASET_GUIDE.md
--
-- Most important tables for ML/DL work:
--   participants
...
--   submissions is the central fact table.
--   Most dataset exports should start from submissions and LEFT JOIN:
--   submission_behavior_metrics, submission_cognitive_metrics, images,
--   participants, and optionally submission_alignment_mentions /
--   attention_events / participant_attention_stats.
-- =====================================================================
