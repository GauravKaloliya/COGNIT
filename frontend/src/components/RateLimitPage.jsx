  ...
  if (reloading) {
    return (
      <div className="app error-page-centered">
        <div className="panel">
          <PageSkeleton
            title={uiText("rateLimit.recoveringTitle")}
            subtitle={uiText("rateLimit.recoveringSubtitle")}
            variant="warning"
            compact
          />
        </div>
      ...
      <div className="panel">
        <div className="page-hero">
          ...
          <PanelState
            ...
            actionLabel={retryIn > 0 ? uiText("common.tryAgainIn", { seconds: retryIn }) : uiText("rateLimit.action")}
